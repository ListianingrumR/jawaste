...
"<p>Jakarta is one of the most densely populated city in the world. The waste management in Jakarta is one of the challenge that is faced by the government. Jakarta is divided into 6 districts, which are Thousand Islands, Central Jakarta, North Jakarta, West Jakarta, East Jakarta and South Jakarta."
...
let divChapter5 =
  ...
  "<p>Waste Generation per day (metric tons): 1368.44";

let divChapter6 =
  "<p><b>West Jakarta</b></p>" + "<hr>" +
  "<p>Area: 125 km²</p>"+
  "<p>Total Population: 2,589,589</p>"+
  "<p>Waste Generation per day (metric tons): 2023.42";

let divChapter7 =
  "<p><b>East Jakarta</b></p>" + "<hr>" +
  "<p>Area: 185,54 km²</p>"+
  "<p>Total Population: 3.274.716</p>"+
  "<p>Waste Generation per day (metric tons): 2313.02";
...
let divChapter11 =
  "<p>To combat the waste crisis in Jakarta, the participation of its citizen is needed. Some of the NGOs in Jakarta araise the awareness by building waste bank to help the government collect the waste.</p>"+
...
var config = {
  style: "mapbox://styles/listianingrumr/cleyzhwq7000t01qax67dzus2",
  accessToken: "pk.eyJ1IjoibGlzdGlhbmluZ3J1bXIiLCJhIjoiY2xkYWhqNDZhMDFpajN2b2JlbWk0b3I5byJ9.MMQjrAuB1KMHcaKfXrnn3w",
  showMarkers: false,
  markerColor: "#327CA7",
  theme: "light",
  use3dTerrain: false,
